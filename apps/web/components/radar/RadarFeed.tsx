...
function PremiumOpportunityHero({ item, lang }: { item: NewsItem; lang: "ru" | "en" }) {
  return (
    <article className="relative isolate min-h-[470px] overflow-hidden rounded-[26px] border border-white/10 bg-[#181510] shadow-[0_30px_90px_rgba(0,0,0,.35)] sm:min-h-[520px]">
      ...
      <div className="relative flex min-h-[470px] max-w-[720px] flex-col justify-center px-6 py-12 text-[#1b1916] sm:min-h-[520px] sm:px-12 lg:px-16">
        <div className="mb-6 inline-flex w-fit rounded-full border border-black/10 bg-white/60 px-4 py-2 text-[10px] font-bold uppercase tracking-[.18em] backdrop-blur">{lang === "ru" ? "Живой сигнал · проверяется сейчас" : "Live signal · verification in progress"}</div>
